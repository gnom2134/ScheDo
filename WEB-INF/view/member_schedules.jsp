...
<ul>
    <c:forEach items="${schedules}" var="schedule">
        <li><a class="btn btn-primary" role="button" href="member_schedule?id=<c:out value="${schedule.id}"/>">${schedule.name}</a></li>
    </c:forEach>
</ul>

<a class="btn btn-primary" role="button" href="recommend_schedule?id=${user_id}" style="margin: 15px;">Recommend schedule</a>
</body>
</html>