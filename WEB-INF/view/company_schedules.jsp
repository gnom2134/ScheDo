...
<ul>
    <c:forEach items="${schedules}" var="schedule">
        <li><a class="btn btn-primary" role="button" href="schedule?id=<c:out value="${schedule.id}"/>">${schedule.name}</a></li>
    </c:forEach>
</ul>

<a class="btn btn-primary" role="button" href="new_company_schedule" style="margin: 15px;">Create new schedule</a>
</body>
</html>