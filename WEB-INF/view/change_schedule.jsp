    ...
    <script>
        ...
        function addActivity(dayId) {
            ...
            document.getElementById("list_" + dayId).innerHTML = list + "<li>\n" +
                "                    <label>Delete? <input type=\"checkbox\" formmethod=\"post\" name=\"is_delete\" value=\"+ counter +\"></label>\n" +
                ...
                "                    <label><input type=\"hidden\" name=\"item_id\" formmethod=\"post\" value=\"+ counter +\" required></label>\n" +
                "                </li>"
            counter = counter - 1;
        }
