...
<a class="btn btn-primary" role="button" href="accept?id=${schedule_id}&recommendation_id=${recommendation_id}" style="margin: 15px;">Accept schedule</a>
<a class="btn btn-primary" role="button" href="decline?id=${recommendation_id}" style="margin: 15px;">Decline schedule</a>
</body>
</html>