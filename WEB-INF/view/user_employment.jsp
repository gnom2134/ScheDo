...
<ul>
    ...
    <c:forEach items="${requests}" var="request">
        <li><a class="btn btn-primary" role="button" href="request_page?user_id=${request.user_id}&company_id=${request.company_id}&comment=${request.comment}">${request.comment}</a></li>
    </c:forEach>
    <h1>Companies</h1>
