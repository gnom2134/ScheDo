...
<c:forEach items="${recommendations}" var="recommendation">
    <li><a class="btn btn-primary" role="button" href="recommended_schedule?id=${recommendation.id}&recommendation_id=${recommendation.recommendationId}">${recommendation.name}</a></li>
</c:forEach>
